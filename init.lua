...
-- vim.keymap.set('n', '<leader>tt', require("neotest").run.run(), { desc = 'Test single function on hover' })
-- [[ Highlight on yank ]]
...
vim.keymap.set('n', '<leader>ls', function() require('telescope.builtin').lsp_document_symbols({ symbol_width = 60 }) end,
  { desc = '[L]ist [S]ymbols' })
